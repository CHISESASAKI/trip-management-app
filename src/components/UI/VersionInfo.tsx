...
export function VersionInfo({ className = '' }: VersionInfoProps) {
  ...
  return (
    <button
      ...
      className={`fixed bottom-4 right-4 z-[1002] bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center shadow-lg hover:bg-blue-700 transition-colors ${className}`}
