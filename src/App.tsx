    ...
    <div className="h-screen flex relative">
      ...
      <div className="flex-1 relative">
        ...
        <button
          ...
          className="md:hidden absolute top-4 right-4 z-20 bg-white rounded-lg shadow-lg p-3 hover:bg-gray-50 transition-colors"
      ...
      <div className={`
        ...
        fixed right-0 top-0 w-80 bg-white shadow-xl
